...
export default function PlanningNavbar() {
  ...
  return (
    <Card className="fixed top-20 mt-4 left-0 h-[calc(100vh-2rem)] w-full max-w-[15rem] p-4  shadow-blue-gray-100/5 bg-[#F1F2F4]">
      <List className="bg-[#F1F2F4]">
        <Link
          to="/planner/calendar"
          className="flex items-center font-medium text-lg text-black"
        >
          <ListItem
            className={`w-[200px] ${
