          ...
          <div className='flex justify-center w-full mt-20 '>
            <div className='w-96'>
              ...
              <div className='mt-9'>
                ...
                <Typography variant='h6' className='mt-6 text-gray-500' >Type the new password</Typography>
                <div className='mt-4'>
                  <Input
                    type="password"
                ...
                <div className='flex justify-center w-full mt-5 gap-3 '>
                  <Button className='w-40' type='submit' onClick={handleSubmit(onSubmit)}>Let's go!</Button>
                  <Button className='w-40 bg-none'>Cancel</Button>
                </div>
              </div>
            </div>
          </div>
