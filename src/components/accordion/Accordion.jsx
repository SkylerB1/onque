...
function Accordion({ children, title,icon,open ,onClick}) {
  return (
    <CustomAccordion
      open={open}
      className={`border border-blue-gray-100 rounded-lg mb-2 ${open === true && 'accordian-container'}`}
      icon={<ExpandMoreIcon width={25} height={25} />}
    >
      <AccordionHeader onClick={onClick} className="border-b-0 ">
